...
class RoleTest extends TestCase
{
    protected function setUp(): void
    {
        ...
        $this->setPermissions([PermissionEnum::ROLES_MANAGE]); // 角色管理权限
    }
    ...
    // 测试添加角色权限
    public function test_role_create_by_permission_role_create()
    {
    ...
    public function test_role_store_by_permission_role_create()
    {
