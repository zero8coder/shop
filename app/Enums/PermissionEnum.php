...
class PermissionEnum extends Enum
{
    ...
    const ADMINS_VIEW_ANY = '查看后台人员列表';
    ...
    const PERMISSIONS_VIEW_ANY = '查看权限列表';
    ...
    const MENU_VIEW_ANY = '查看菜单列表';
    const MENU_CREATE = '添加菜单';
    const MENU_UPDATE = '修改菜单';
    const MENU_DELETE = '删除菜单';
